                                        ...
                                        <ul class="onhover-show-div left-dropdown">
                                            ...
                                            <li class="flyout-right"><a href="#">Others </a><i
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="flyout-right"><a href="#">Email
                                                            templates</a>
                                                        <ul>
                                        ...
                                        <ul class="onhover-show-div left-dropdown">
                                            <li class="flyout-right"><a href="#">Gallery</a>
                                                <ul>
                                                    ...
                                                    <li><a
                                                            href="gallery-with-description.html">gallery-with-description</a>
                                                    </li>
                                                    <li><a href="gallery-masonry.html">gallery-masonry</a></li>
                                                    <li><a
                                                            href="masonry-gallery-with-disc.html">masonry-gallery-with-disc</a>
                                                    </li>
                                            ...
                                            <li class="flyout-right"><a href="#">Job Search</a>
                                                <ul>
                                                    ...
                                                    <li><a href="learning-detailed.html">learning-detailed</a>
                                                    </li>
                                                </ul><i class="fa fa-angle-right"></i>
                                            </li>
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">
                                    <svg class="stroke-icon">
                                        <use
                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#stroke-home">
                                        </use>
                                    </svg></a></li>
                            ...
                            <div class="row premium-courses-card">
                                <div class="col-md-5 premium-course">
                                    <h1 class="f-w-700">Get Thousands Premium Courses.</h1><span
                                        class="f-light f-w-400 f-14">Upgrade to watch, play, learn, make and
                                        discover. </span><a class="btn btn-square btn-primary f-w-700"
                                        href="pricing.html">Go Premium</a>
                                </div>
                                <div class="col-md-7 premium-course-img">
                                    <div class="premium-message"><img class="img-fluid"
                                            src="{{ asset('backend/images/dashboard/massage.gif') }}" alt="massage">
                                    </div>
                                    <div class="premium-books"><img class="img-fluid"
                                            src="{{ asset('backend/images/dashboard/books.gif') }}" alt="books"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="header-top">
                                ...
                                <div class="dropdown icon-dropdown setting-menu">
                                    <button class="btn dropdown-toggle" id="userdropdown1" type="button"
                                        ...
                                        <svg>
                                            <use
                                                href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#setting">
                                            </use>
                                        </svg>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown1"><a
                                            ...
                                            href="#">Monthly </a><a class="dropdown-item" href="#">Yearly
                                        </a></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li class="activity-removed">
                                        <div class="recent-activity-data">
                                            <div class="activity-name"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Chat">
                                                        </use>
                                                    </svg></span><a href="letter-box.html">Nick Mark mentioned
                                                    Sara</a></div>
                                            <div class="view-btn"><a href="#!">View
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Arrow-Right-2">
                                                        </use>
                                                    </svg></a></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="recent-activity-data">
                                            <div class="activity-name"> <span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Download">
                                                        </use>
                                                    </svg></span><a href="letter-box.html">The Post name was
                                                    removed...</a></div>
                                            <div class="view-btn"><a href="#!">View
                                                    <svg>
                                                        <use
                                    ...
                                    <li>
                                        <div class="recent-activity-data">
                                            <div class="activity-name"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Swap">
                                                        </use>
                                                    </svg></span><a href="letter-box.html">Patrick Sullivan
                                                    published... </a></div>
                                            <div class="view-btn"><a href="#!">View
                                                    <svg>
                                                        <use
                                    ...
                                    <li>
                                        <div class="recent-activity-data">
                                            <div class="activity-name"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Send">
                                                        </use>
                                                    </svg></span><a href="letter-box.html">Nick Mark mentioned
                                                    Sara</a></div>
                                            <div class="view-btn"><a href="#!">View
                                    ...
                                    <li>
                                        <div class="recent-activity-data">
                                            <div class="activity-name"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Work">
                                                        </use>
                                                    </svg></span><a href="letter-box.html">The Post name was
                                                    removed...</a></div>
                                            <div class="view-btn"> <a href="#!">View
                                ...
                                <table class="last-orders-table table" id="last-orders">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="user-data">
                                                    <div><img src="{{ asset('backend/images/dashboard/avtar/2.jpg') }}"
                                                            alt="avatar"></div>
                                            ...
                                            <td>
                                                <div class="dropdown icon-dropdown">
                                                    <button class="btn dropdown-toggle" id="userdropdownes4"
                                                        type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <div class="drop-menu"><i class="icon-more-alt"></i>
                                                        </div>
                                                    </button>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="user-data">
                                                    <div><img src="{{ asset('backend/images/dashboard/avtar/17.jpg') }}"
                                                            alt="avatar"></div>
                                                    <div><a href="user-profile.html">
                                            ...
                                            <td>
                                                <div class="dropdown icon-dropdown">
                                                    <button class="btn dropdown-toggle" id="userdropdownes1"
                                                        type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <div class="drop-menu"><i class="icon-more-alt"></i>
                                                        </div>
                                                    </button>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="user-data">
                                                    <div><img src="{{ asset('backend/images/avtar/18.jpg') }}"
                                                            alt="avatar"></div>
                                                    <div><a href="user-profile.html">
                                                            <h4>Kevin Greem</h4>
                                            ...
                                            <td>
                                                <div class="dropdown icon-dropdown">
                                                    <button class="btn dropdown-toggle" id="userdropdownes2"
                                                        type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <div class="drop-menu"><i class="icon-more-alt"></i>
                                                        </div>
                                                    </button>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="user-data">
                                                    <div><img src="{{ asset('backend/images/dashboard/avtar/19.jpg') }}"
                                                            alt="avatar"></div>
                                                    <div><a href="user-profile.html">
                                            ...
                                            <td>
                                                <div class="dropdown icon-dropdown">
                                                    <button class="btn dropdown-toggle" id="userdropdownes3"
                                                        type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <div class="drop-menu"><i class="icon-more-alt"></i>
                                                        </div>
                                                    </button>
                                    ...
                                    <li>
                                        <div class="monthly-data">
                                            <div class="invoice-data-icon"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#bookmark">
                                                        </use>
                                                    </svg></span>
                                            ...
                                            <div class="invoice-price"><span>$12,453.00</span><span>Per
                                                    Month</span></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="monthly-data">
                                            <div class="invoice-data-icon"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Ticket-Star">
                                                        </use>
                                                    </svg></span>
                                                <div><a href="#">
                                            ...
                                            <div class="invoice-price"><span>$54,459.00</span><span>Per
                                                    month</span></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="monthly-data">
                                            <div class="invoice-data-icon"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Discovery">
                                                        </use>
                                                    </svg></span>
                                            ...
                                            <div class="invoice-price"><span>$87,884.00</span><span>Per
                                                    month</span></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="monthly-data">
                                            <div class="invoice-data-icon"><span>
                                                    <svg>
                                                        <use
                                                            href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Shield-Done">
                                                        </use>
                                                    </svg></span>
                                            ...
                                            <div class="invoice-price"><span>$79,955.00 </span><span>Per
                                                    month</span></div>
                                        </div>
                                    </li>
                                    <li>
                                        <button class="btn btn-outline-light txt-dark active w-100" type="button"><a
                                                ...
                                                <svg>
                                                    <use
                                                        href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Plus-Circle">
                                                    </use>
                                ...
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle custom-date-btn" id="dropdownMenuButton"
                                        ...
                                        <div class="custom-date">
                                            <svg>
                                                <use
                                                    href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Left-Arrow">
                                                </use>
                                            </svg>
                                            <svg>
                                                <use
                                                    href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Right-Arrow">
                                                </use>
                                            </svg>
                                        </div>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"><a
                                            class="dropdown-item" href="#">11 Aug - 21 Aug</a><a
                                            class="dropdown-item" href="#">07 Sep - 23 Sep</a><a
                                            class="dropdown-item" href="#">01 Otc - 15 Otc</a></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="arrow-up">
                                            <svg>
                                                <use
                                                    href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Arrow-Up">
                                                </use>
                                            </svg>
                                        </div><span>$5.850</span>
                                    </li>
                                    <li>
                                        <div class="arrow-down">
                                            <svg>
                                                <use
                                                    href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Arrow-Down">
                                                </use>
                                            </svg>
                                        </div><span>$1.750</span>
                                    </li>
                        ...
                        <div class="card-body pt-0">
                            <div class="notification-card">
                                <ul>
                                    <li>
                                        <div class="user-notification">
                                            ...
                                            <div class="user-description"><a href="letter-box.html">
                                                    <h4>You have new comments in real finical law agency landing
                                                        page design.</h4>
                                    ...
                                    <li>
                                        <div class="user-notification">
                                            <div><img src="{{ asset('backend/images/dashboard/avtar/17.jpg') }}"
                                                    alt="avatar"></div>
                                            <div class="user-description"><a href="letter-box.html">
                                                    <h4>Congrats! you complete all task for today. just need to join
                                                        meting.</h4>
                                    ...
                                    <li>
                                        <div class="user-notification">
                                            <div> <img src="{{ asset('backend/images/dashboard/avtar/18.jpg') }}"
                                                    alt="avatar"></div>
                                            <div class="user-description"><a href="letter-box.html">
                                                    <h4>You have new comments in real finical law agency landing
                                                        page design.</h4>
                                ...
                                <table class="project-summary table" id="project-summary">
                                    ...
                                    <tbody>
                                                ...
                                                <div class="customers d-inline-block avatar-group">
                                                    <ul>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/8.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/10.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/2.jpg') }}"
                                                                alt=""></li>
                                                ...
                                                <div class="customers d-inline-block avatar-group">
                                                    <ul>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                ...
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/20.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/12.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block">
                                                            <p>6+</p>
                                                        </li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="f-w-600"> <a href="projects.html">Cytrust Dashboard</a>
                                            </td>
                                            <td class="team-avtar">
                                                <div class="customers d-inline-block avatar-group">
                                                    <ul>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/14.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/13.jpg') }}"
                                                                alt=""></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="team-avtar">
                                                <div class="customers d-inline-block avatar-group">
                                                    <ul>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/22.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/15.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/2.jpg') }}"
                                                                alt=""></li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="team-avtar">
                                                <div class="customers d-inline-block avatar-group">
                                                    <ul>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/21.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/23.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                                src="{{ asset('backend/images/dashboard/avtar/24.jpg') }}"
                                                                alt=""></li>
                                                        <li class="d-inline-block">
                                                            <p>5+ </p>
                                                        </li>
                                ...
                                <ul>
                                    <li>
                                        <div class="total-sales">
                                            ...
                                            <div class="total-reached"><span>1,00,00</span><span>85% goal
                                                    reached</span></div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="total-sales">
                                            ...
                                            <div class="total-reached"> <span>1,00,00</span><span>45% goal reached
                                                </span></div>
                                        </div>
                                        <div class="progress-data">
