                        ...
                        <div class="h-300px p-3" data-scrollbar="true">
                            <div class="d-sm-flex">
                                <a href="javascript:;" class="w-sm-200px">
                                    <img class="mw-100 rounded" src="{{ asset('backend/img/gallery/gallery-1.jpg') }}"
                                        alt="" />
                                </a>
                            ...
                            <div class="d-sm-flex">
                                <a href="javascript:;" class="w-sm-200px">
                                    <img class="mw-100 rounded" src="{{ asset('backend/img/gallery/gallery-10.jpg') }}"
                                        alt="" />
                                </a>
                                <div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
                            ...
                            <div class="d-sm-flex">
                                <a href="javascript:;" class="w-sm-200px">
                                    <img class="mw-100 rounded" src="{{ asset('backend/img/gallery/gallery-7.jpg') }}"
                                        alt="" />
                                </a>
                                <div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
                            ...
                            <div class="d-sm-flex">
                                <a href="javascript:;" class="w-sm-200px">
                                    <img class="mw-100 rounded" src="{{ asset('backend/img/gallery/gallery-8.jpg') }}"
                                        alt="" />
                                </a>
                                <div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="hidden-sm text-center">
                                            <a href="javascript:;">
                                                <img src="{{ asset('backend/img/product/product-1.png') }}" alt=""
                                                    width="32px" />
                                            </a>
                                        </td>
                                        <td class="text-nowrap">
                                            <h6><a href="javascript:;" class="text-dark text-decoration-none">Nunc
                                                    eleifend lorem eu
                                                    velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-sm text-center">
                                            <a href="javascript:;">
                                                <img src="{{ asset('backend/img/product/product-2.png') }}" alt=""
                                                    width="32px" />
                                            </a>
                                        </td>
                                        <td class="text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-sm text-center">
                                            <a href="javascript:;">
                                                <img src="{{ asset('backend/img/product/product-3.png') }}" alt=""
                                                    width="32px" />
                                            </a>
                                        </td>
                                        <td class="text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-sm text-center">
                                            <a href="javascript:;">
                                                <img src="{{ asset('backend/img/product/product-4.png') }}" alt=""
                                                    width="32px" />
                                            </a>
                                        </td>
                                        <td class="text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td class="hidden-sm text-center">
                                            <a href="javascript:;">
                                                <img src="{{ asset('backend/img/product/product-5.png') }}" alt=""
                                                    width="32px" />
                                            </a>
                                        </td>
                                        <td class="text-nowrap">
                        ...
                        <div class="h-300px p-3" data-scrollbar="true">
                            <div class="d-flex">
                                <a class="w-60px" href="javascript:;">
                                    <img src="{{ asset('backend/img/user/user-1.jpg') }}" alt=""
                                ...
                                <div class="flex-1 ps-3">
                                    ...
                                    <span class="text-muted fs-11px fw-bold">Received on 04/16/2024,
                                        12.39pm</span>
                                </div>
                            </div>
                            <hr class="bg-gray-500" />
                            <div class="d-flex">
                                <a class="w-60px" href="javascript:;">
                                    <img src="{{ asset('backend/img/user/user-2.jpg') }}" alt=""
                                        class="mw-100 rounded-pill" />
                                </a>
                                <div class="flex-1 ps-3">
                                    <a href="javascript:;" class="text-dark text-decoration-none">
                            ...
                            <div class="d-flex">
                                <a class="w-60px" href="javascript:;">
                                    <img src="{{ asset('backend/img/user/user-3.jpg') }}" alt=""
                                        class="mw-100 rounded-pill" />
                                </a>
                                <div class="flex-1 ps-3">
                                    <a href="javascript:;" class="text-dark text-decoration-none">
                            ...
                            <div class="d-flex">
                                <a class="w-60px" href="javascript:;">
                                    <img src="{{ asset('backend/img/user/user-4.jpg') }}" alt=""
                                        class="mw-100 rounded-pill" />
                                </a>
                                <div class="flex-1 ps-3">
                                    <a href="javascript:;" class="text-dark text-decoration-none">
                        ...
                        <div class="h-300px p-3" data-scrollbar="true">
                            <div class="d-flex">
                                <a href="javascript:;" class="w-60px">
                                    <img src="{{ asset('backend/img/user/user-5.jpg') }}" alt=""
                                        class="mw-100 rounded-pill" />
                                </a>
                                <div class="flex-1 ps-3">
                                    <h5>John Doe</h5>
                            ...
                            <div class="d-flex">
                                <a href="javascript:;" class="w-60px">
                                    <img src="{{ asset('backend/img/user/user-6.jpg') }}" alt=""
                                        class="mw-100 rounded-pill" />
                                </a>
                                <div class="flex-1 ps-3">
                                    <h5>Terry Ng</h5>
                            ...
                            <div class="d-flex">
                                <a href="javascript:;" class="w-60px">
                                    <img src="{{ asset('backend/img/user/user-8.jpg') }}" alt=""
                                        class="mw-100 rounded-pill" />
                                </a>
                                <div class="flex-1 ps-3">
                                    <h5>Fiona Log</h5>
                            ...
                            <div class="d-flex">
                                <a href="javascript:;" class="w-60px">
                                    <img src="{{ asset('backend/img/user/user-7.jpg') }}" alt=""
                                        class="mw-100 rounded-pill" />
                                </a>
                                <div class="flex-1 ps-3">
                                    <h5>John Doe</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-panel align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td nowrap><label class="badge bg-default text-gray-900">% New Visits</label>
                                    </td>
                                    <td>40.5%</td>
                                    <td>
