<div class="theme-panel">
    ...
    <div class="theme-panel-content" data-scrollbar="true" data-height="100%">
        ...
        <div class="theme-version">
            <div class="theme-version-item">
                <a href="index-2.html" class="theme-version-link active">
                    <span style="background-image: url({{ asset('backend/img/version/html.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/ajax/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/ajax.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/angularjs/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/angular1x.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/angularjs18/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/angular10x.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/svelte/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/svelte.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="javascript:alert('Laravel 11 Version only available in downloaded version.');"
                    ...
                    <span style="background-image: url({{ asset('backend/img/version/laravel.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="javascript:alert('Django Version only available in downloaded version.');"
                    class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/django.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/vue3/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/vuejs.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/react/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/reactjs.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="javascript:alert('.NET Core 8.0 MVC Version only available in downloaded version.');"
                    class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/version/dotnet.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
        </div>
        ...
        <div class="theme-version">
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/one-page-parallax/"
                    class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/theme/one-page-parallax.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/e-commerce/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/theme/e-commerce.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/blog/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/theme/blog.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/forum/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/theme/forum.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/corporate/" class="theme-version-link">
                    <span style="background-image: url({{ asset('backend/img/theme/corporate.jpg') }})"
                        class="theme-version-cover"></span>
                </a>
            </div>
        </div>
