    ...
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"> <img class="img-fluid for-light"
                        src="{{ asset('backend/images/logo/logo.png') }}" alt=""><img
                        class="img-fluid for-dark" src="{{ asset('backend/images/logo/logo_dark.png') }}"
                        alt=""></a></div>
            <div class="toggle-sidebar">
                <svg class="sidebar-toggle">
                    <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#stroke-animation">
                    </use>
                </svg>
            </div>
        </div>
                ...
                <div class="Typeahead Typeahead--twitterUsers">
                    <div class="u-posRelative">
                        ...
                        <svg class="search-bg svg-color">
                            <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#search"></use>
                        </svg>
                    </div>
                </div>
            </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="notification-box">
                        <svg>
                            <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Bell"></use>
                        </svg>
                    </div>
                            ...
                            <ul>
                                <li>
                                    <div class="user-notification">
                                        <div><img src="{{ asset('backend/images/avtar/2.jpg') }}" alt="avatar">
                                        </div>
                                ...
                                <li>
                                    <div class="user-notification">
                                        <div><img src="{{ asset('backend/images/avtar/17.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="user-description"><a href="letter-box.html">
                                ...
                                <li>
                                    <div class="user-notification">
                                        <div> <img src="{{ asset('backend/images/avtar/18.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="user-description"><a href="letter-box.html">
                                ...
                                <li>
                                    <div class="user-notification">
                                        <div><img src="{{ asset('backend/images/avtar/19.jpg') }}" alt="avatar">
                                        </div>
                                        <div class="user-description"><a href="letter-box.html">
                                                <h4>Congrats! you all task for today.</h4>
                                            </a><span>Today 06:55pm</span></div>
                ...
                <li class="onhover-dropdown">
                    <svg>
                        <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Bookmark"></use>
                    </svg>
                            ...
                            <div class="flip-card-inner">
                                <div class="front">
                                    ...
                                    <ul class="bookmark-dropdown">
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-center"><a
                                                        href="bootstrap-basic-table.html">
                                                        <div class="bookmark-content">
                                        ...
                                        <li class="text-centermedia-body"> <a class="flip-btn f-w-700"
                                                id="flip-btn" href="javascript:void(0)">Add New Bookmark</a></li>
                                    </ul>
                                </div>
                                <div class="back">
                                    <ul>
                ...
                <li class="onhover-dropdown">
                    <div class="message position-relative">
                        <svg>
                            <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Message">
                            </use>
                    ...
                    <div class="onhover-show-div message-dropdown">
                        ...
                        <ul>
                            <li>
                                <div class="d-flex align-items-start">
                                    <div class="message-img bg-light-primary"><img
                                            src="{{ asset('backend/images/user/3.jpg') }}" alt=""></div>
                            ...
                            <li>
                                <div class="d-flex align-items-start">
                                    <div class="message-img bg-light-primary"><img
                                            src="{{ asset('backend/images/user/6.jpg') }}" alt=""></div>
                                    <div class="flex-grow-1">
                            ...
                            <li>
                                <div class="d-flex align-items-start">
                                    <div class="message-img bg-light-primary"><img
                                            src="{{ asset('backend/images/user/10.jpg') }}" alt=""></div>
                                    <div class="flex-grow-1">
                ...
                <li class="cart-nav onhover-dropdown">
                    <div class="cart-box">
                        <svg>
                            <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Buy"></use>
                        </svg>
                    </div>
                        ...
                        <ul>
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 img-50"
                                        src="{{ asset('backend/images/ecommerce/05.jpg') }}" alt="">
                            ...
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 img-50"
                                        src="{{ asset('backend/images/ecommerce/02.jpg') }}" alt="">
                            ...
                            <li class="text-center"> <a href="cart.html">
                                    <button class="btn btn-outline-primary" type="button">View
                                        Cart</button></a><a class="btn btn-primary view-checkout"
                ...
                <li>
                    <div class="mode">
                        <svg class="for-dark">
                            <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#moon"></use>
                        </svg>
                        <svg class="for-light">
                            <use href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#Sun"></use>
                        </svg>
                    </div>
                </li>
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="d-flex align-items-center profile-media"><img class="b-r-25"
                            src="{{ asset('backend/images/dashboard/profile.png') }}" alt="">
                        <div class="flex-grow-1 user"><span>Helen Walter</span>
                            <p class="mb-0 font-nunito">Admin
                                <svg>
                                    <use
                                        href="http://localhost/insurances/public/backend/svg/icon-sprite.svg#header-arrow-down">
                                    </use>
                                </svg>
                            </p>
                        </div>
