...
<head>
    ...
    <title>Zono - Insurance Management</title>
    <!-- Google font -->
...
<body>
    ...
    <script src="{{ asset('backend/js/chart/morris-chart/raphael.js') }}"></script>
    <script src="{{ asset('backend/js/chart/morris-chart/morris.js') }}"></script>
    <script src="{{ asset('backend/js/chart/morris-chart/prettify.min.js') }}"></script>
    ...
    <script src="{{ asset('backend/js/owlcarousel/owl-custom.js') }}"></script>
