                                ...
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            ...
                                            data-src="{{ asset('frontend/images/common/products/img-07.jpg') }}" alt="Laptop Cover"
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            src="{{ asset('frontend/images/common/img-fallback.png') }}"
                                            data-src="{{ asset('frontend/images/common/products/img-08.jpg') }}" alt="Disney Toys"
                                            data-uc-img="loading: lazy">
                                        <a href="shop-product-detail.html" class="position-cover"
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            src="{{ asset('frontend/images/common/img-fallback.png') }}"
                                            data-src="{{ asset('frontend/images/common/products/img-09.jpg') }}" alt="Screen Axe"
                                            data-uc-img="loading: lazy">
                                        <a href="shop-product-detail.html" class="position-cover"
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            src="{{ asset('frontend/images/common/img-fallback.png') }}"
                                            data-src="{{ asset('frontend/images/common/products/img-10.jpg') }}" alt="Airpods Pro"
                                            data-uc-img="loading: lazy">
                                        <a href="shop-product-detail.html" class="position-cover"
            ...
            <div class="row md:child-cols-6 col-match g-0">
                <div class="d-none md:d-flex">
                    <div class="position-relative w-100 ratio-1x1">
                        <img class="media-cover" src="{{ asset('frontend/images/demo-seven/common/newsletter.jpg') }}"
                                                            ...
                                                            <article
                                                                ...
                                                                <div class="post-media panel overflow-hidden">
                                                                    <div
                                                                        ...
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                            src="{{ asset('frontend/images/common/img-fallback.png') }}"
                                                                            data-src="{{ asset('frontend/images/demo-seven/posts/img-21.jpg') }}"
                                                            ...
                                                            <article
                                                                ...
                                                                <div class="post-media panel overflow-hidden">
                                                                    <div
                                                                        ...
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                            src="{{ asset('frontend/images/common/img-fallback.png') }}"
                                                                            data-src="{{ asset('frontend/images/demo-seven/posts/img-22.jpg') }}"
                                                        ...
                                                        <div>
                                                            <article
                                                                ...
                                                                <div class="post-header panel vstack gap-narrow">
                                                                    <h3 class="post-title h6 m-0 text-truncate-2">
                                                                        <a class="text-none hover:text-primary duration-150"
                                                                            href="blog-details.html">Gaming in the Age
                                                                            of AI: Strategies for Startups</a>
                                                                    </h3>
                                                                    <div
                                                                        class="post-meta panel hstack justify-start gap-1 fs-7 ft-tertiary fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1 d-none md:d-block">
                                                                        <div>
                                                ...
                                                <div class="row child-cols g-4">
                                                    <div>
                                                        <ul class="uc-nav uc-navbar-dropdown-nav">
                                                            ...
                                                            <li><a href="index.html">Main</a></li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-two/index.html">Classic
                                                                    News</a></li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-three/index.html">Tech</a>
                                                            </li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-four/index.html">Classic
                                                                    Blog</a></li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-five/index.html">Gaming</a>
                                                            </li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-six/index.html">Sports</a>
                                                            </li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-seven/index.html">Newspaper</a>
                                                            </li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-eight/index.html">Magazine</a>
                                                            </li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-nine/index.html">Travel</a>
                                                            </li>
                                                            <li><a
                                                                    href="https://html.themewant.com/news5/demo-ten/index.html">Food</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="col-3">
                                                <div class="panel w-100 overflow-hidden">
                                                    <div class="ratio ratio-3x4 overflow-hidden">
                                                        <img src="{{ asset('frontend/images/common/menu-banner.jpg') }}"
                            ...
                            <div class="uc-logo d-block md:d-none">
                                <a href="index.html">
                                    <img class="w-100px text-dark dark:text-white"
                                        src="https://html.themewant.com/news5/assets/images/demo-seven/common/logo.svg"
                                        alt="News5" data-uc-svg>
                                </a>
                            </div>
                        </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <h3 class="post-title h6 m-0 text-truncate-2">
                                                                    <a class="text-none hover:text-primary duration-150"
                                                                        ...
                                                                        of Gourmet Street Food: Trends and Top Picks</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                <div>
                                                                    <div
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                href="blog-details.html">Tech Tools
                                                                                for your Time Management: Enhancing
                                                                                Productivity</a>
                                                                        </h3>
                                                                        <div
                                                                            class="post-date hstack gap-narrow fs-7 text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                ...
                                                                                Immersive Technologies help your
                                                                                Business Grow</a>
                                                                        </h3>
                                                                        <div
                                                                            class="post-date hstack gap-narrow fs-7 text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                ...
                                                                                Agility the Digital Age: Leveraging AI
                                                                                and Automation</a>
                                                                        </h3>
                                                                        <div
                                                                            class="post-date hstack gap-narrow fs-7 text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                            ...
                                                            <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                                <div>
                                                                    <div
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                href="blog-details.html">A Guide to
                                                                                The Rise of Gourmet Street Food: Trends
                                                                                and Top Picks</a>
                                                                        </h3>
                                                                        <div
                                                                            class="post-date hstack gap-narrow fs-7 text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h3 class="post-title h6 m-0 text-truncate-2">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                ...
                                                                                Independent Contractors to Invest in
                                                                                Best of Startups</a>
                                                                        </h3>
                                                                        <div
                                                                            class="post-date hstack gap-narrow fs-7 text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                        ...
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    ...
                                                                    Law enforcement officers have been accused of
                                                                    sexually abusing children over the past two decades,
                                                                    a Post investigation found. Nisi dignissim tortor
                                                                    sed quam sed ipsum ut. Dolor sit amet, consectetur
                                                                    adipiscing elit.</p>
                                                                <div class="post-link">
                                                                    <a href="blog-details.html"
                                                    ...
                                                    <article class="post type-post panel uc-transition-toggle">
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    class="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">
                                                                    Officers have been accused of sexually abusing
                                                                    children over the past two decades, a Post
                                                                    investigation found. Nisi dignissim tortor sed quam
                                                            ...
                                                            <div>
                                                                <div
                                                                    ...
                                                                    <h3
                                                                        class="post-title h5 lg:h4 m-0 text-truncate-2">
                                                                        <a class="text-none hover:text-primary duration-150"
                                                                            href="blog-details.html">Balancing Work
                                                    ...
                                                    <article class="post type-post panel uc-transition-toggle">
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    class="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">
                                                                    Post investigation found. Nisi dignissim tortor sed
                                                                    quam sed ipsum ut. Dolor sit amet, consectetur
                                                                    adipiscing elit.</p>
                                                                <div class="post-link">
                                                                    <a href="blog-details.html"
                                                                        class="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                    ...
                                                    <article class="post type-post panel uc-transition-toggle">
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    class="post-excrept ft-tertiary fs-6 text-gray-900 dark:text-white text-opacity-60 text-truncate-2 my-1">
                                                                    Nisi dignissim tortor sed quam sed ipsum ut. Dolor
                                                                    sit amet, consectetur adipiscing elit To spread the
                                                                    word, the company embarked on a mass marketing
                                                                    drive. TV campaigns launched in the platform’s key
                                                                    markets.</p>
                                                                <div class="post-link">
                                                                    <a href="blog-details.html"
                                                                        class="link fs-7 fw-bold text-uppercase text-none mt-1 pb-narrow p-0 border-bottom dark:text-white">
                                                        ...
                                                        <div class="row child-cols g-2 lg:g-3" data-uc-grid>
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    ...
                                                                    marketing drive. TV campaigns launched in the
                                                                    platform’s key markets. Nisi dignissim tortor sed
                                                                    quam sed ipsum ut. Dolor sit amet, consectetur
                                                                    adipiscing elit.</p>
                                                                <div class="post-link">
                                                                    <a href="blog-details.html"
                                                            ...
                                                            <div>
                                                                <div
                                                                    ...
                                                                    <h3
                                                                        class="post-title h5 lg:h4 m-0 text-truncate-2">
                                                                        <a class="text-none hover:text-primary duration-150"
                                                                            href="blog-details.html">The Art of
                                                                            Baking: From Classic Bread to Artisan
                                                                            Pastries</a>
                                                                    </h3>
                                                                </div>
                                                                <p
                                        ...
                                        <div class="widgt-content">
                                            <a class="cstack max-w-300px mx-auto text-none"
                                                ...
                                                <img class="d-block dark:d-none"
                                                    src="{{ asset('frontend/images/common/ad-slot-aside.jpg') }}" alt="Ad slot">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h3 class="post-title h6 m-0">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                ...
                                                                                Reality and Mental Health: Exploring the
                                                                                Therapeutic</a>
                                                                        </h3>
                                                                        <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h3 class="post-title h6 m-0">
                                                                            <a class="text-none hover:text-primary duration-150"
                                                                                ...
                                                                                Businesses Are Adapting to E-Commerce
                                                                                and AI Integration</a>
                                                                        </h3>
                                                                        <div
                                                                            class="post-meta panel hstack justify-between fs-7 text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex">
                                                                            <div class="meta">
